            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, axios_1.default.post("https://fakestoreapi.com/products", newProduct)];
                        case 2:
                            response = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, axios_1.default.put("https://fakestoreapi.com/products/".concat(productId), updatedProduct)];
                        case 2:
                            response = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios_1.default.delete("https://fakestoreapi.com/products/".concat(productId))];
                        case 1:
                            response = _a.sent();
                            if (response.status === 200) {
                                (0, toastify_js_1.default)({
        ...
        return __generator(this, function (_a) {
            ...
            document.querySelectorAll(".category-btn").forEach(function (button) {
                button.addEventListener("click", function () {
                    var selectedCategory = _this.getAttribute("data-category");
